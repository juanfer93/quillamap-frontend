...
export const LoginScreen = ({ navigation }: any) => {
  ...
  return (
    <KeyboardAvoidingView 
      ...
      style={tw`flex-1 bg-${theme === 'dark' ? 'black' : 'white'}`}
    >
      <ScrollView contentContainerStyle={tw`flex-grow justify-center p-l`}>
        <HeaderSwitch />

        <Text style={tw`text-4xl font-bold text-center mb-l text-${theme === 'dark' ? 'white' : 'shark-blue'}`}>
          Iniciar Sesión
        </Text>
